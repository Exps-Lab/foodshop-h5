...
<template>
  <section class="address-com-box">
    ...
    <section class="shop-box">
      <img class="shop-avatar" :src="props.shopData.shop_image?.avatar" alt="shopImg">
      <span class="shop-title van-ellipsis">{{props.shopData.name}}</span>
    </section>
    <!-- 已选商品信息 -->
    <section class="goods-box">
      <section
        class="goods-list"
        v-for="(goods, index) in props.choseGoodsData"
        :key="index">
    ...
    <section class="ext-mes-box">
      <section class="com-mes">
        ...
        <p class="com-price">
          <span class="com-symbol">￥</span>
          <span class="price">{{totalBagFee}}</span>
        </p>
      </section>
      <section class="com-mes">
        ...
        <p class="com-price">
          <span class="com-symbol">￥</span>
          <span class="price">{{props.shopData.delivery_fee}}</span>
        </p>
      </section>
      <section class="com-mes">
        ...
        <p class="com-price red">
          <span>‐</span>
          <span class="com-symbol">￥</span>
          <span class="price">{{shopDiscount}}</span>
        </p>
      </section>
    </section>
    <van-divider dashed :hairline="false"></van-divider>
